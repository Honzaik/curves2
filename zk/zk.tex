...
Case 4: $u = ax_1x_2 + bx_1 + cx_2 + e \in \bar{K}[x_1,x_2], v = fx_1x_2+gx_1+hx_2+i \in \bar{K}[x_1,x_2]$. W.l.o.g. consider $f \in (K[x_2])[x_1] \iff f = x_1^2(a_1-dx_2^2)+(a_2x_2^2-1)$. Since $\deg_{x_1}(u)=1=\deg_{x_1}(v)$ means that $f = (a'x_1+b')(c'x_1+d') \in (K[x_2])[x_1]$ i.e. $f$ has roots $\frac{b'}{a'}, \frac{d'}{c'} \in \bar{K}(x_2)$. 
